...
5. Another good measure to avoid flooding the stdout() in your Galaxy is  to suppress messages within your R script while loading Bioconductor packages is 
...
7. Feature soon to be available : Conda dependency resolution for R/Bioconductor packages integrated in Galaxy.
